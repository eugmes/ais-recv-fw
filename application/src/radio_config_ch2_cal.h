...
// RF Freq.(MHz): 162.025    API_TC: 29    fhst: 50000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1
...
*/
#define RF_POWER_UP 0x02, 0x81, 0x01, 0x01, 0xE8, 0x48, 0x00

/*
// Command:                  RF_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_GPIO_PIN_CFG 0x13, 0x00, 0x00, 0x11, 0x14, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0xC5
...
*/
#define RF_MODEM_MDM_CTRL_12 0x11, 0x20, 0x0C, 0x19, 0x00, 0x08, 0x02, 0x80, 0x00, 0xB0, 0x10, 0x0C, 0xE8, 0x00, 0x53, 0x06
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_1_12 0x11, 0x20, 0x0C, 0x25, 0x24, 0xDD, 0x00, 0x00, 0x02, 0xC0, 0x08, 0x00, 0x12, 0x00, 0x62, 0x01
...
*/
#define RF_MODEM_AFC_LIMITER_0_2 0x11, 0x20, 0x02, 0x31, 0x74, 0xA0
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3B, 0x0B, 0x00, 0x00, 0x26, 0x66, 0x20, 0xFA
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x0B, 0x00, 0x07, 0x05, 0xDC, 0x00, 0x05, 0xE8, 0x48, 0x00, 0x00, 0x01
...
//   MODEM_BCR_NCO_OFFSET_2 - RX BCR NCO offset value (an unsigned 22-bit number).
*/
#define RF_MODEM_MDM_CTRL_12_1 0x11, 0x20, 0x0C, 0x19, 0x80, 0x08, 0x02, 0x80, 0x00, 0x70, 0x20, 0x00, 0xE8, 0x00, 0x68, 0x04
...
//   MODEM_AFC_LIMITER_1 - Set the AFC limiter value.
*/
#define RF_MODEM_BCR_NCO_OFFSET_1_12_1 0x11, 0x20, 0x0C, 0x25, 0xEA, 0x4B, 0x02, 0x76, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x81, 0x00, 0x02
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_0_2_1 0x11, 0x20, 0x02, 0x31, 0x51, 0x80
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x17, 0x17, 0x80, 0x1A, 0x20, 0x00, 0x00, 0x28, 0x0C, 0x84, 0x23
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8F, 0x00, 0x64, 0x01, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40
...
//   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
*/
#define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x3B, 0x0E, 0x13, 0x33, 0x26, 0x66, 0x20, 0xFA
